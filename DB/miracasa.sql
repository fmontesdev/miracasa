...
-- Tiempo de generación: 09-04-2024 a las 11:36:06
...
(1, '7003051YJ4480S0045AA', 43.461647033691406, -3.819044351577759, 39, 150, 0, 1, 'Planta baja', 'Descubre el potencial de este local comercial a reformar en Santander. Con una ubicación estratégica que garantiza visibilidad y acceso, este espacio ofrece la oportunidad perfecta para dar vida a tu propio negocio. Transforma este local según tus necesidades.', '15-04-2017', 311),
(2, '8204201YJ5210S0087BB', 41.38701164491393, 2.1701472867137825, 6, 15, 0, 0, 'Subsótano', 'Se alquila plaza de garaje en el corazón de Barcelona con acceso cómodo y directo. Esta plaza ofrece conveniencia y seguridad para tu vehículo en una de las zonas más céntricas de la ciudad. Aprovecha esta oportunidad y asegura tu espacio de estacionamiento.', '10-11-2023', 193),
(3, '1234201YJ5210S0087CC', 37.38540018023119, -5.99179181508895, 41, 145, 0, 2, '2ª planta', 'Oportunidad única para establecer tu negocio en el corazón de Sevilla. Estas oficinas amuebladas ofrecen un entorno profesional y moderno con calefacción y aire acondicionado. Ubicación estratégica, mobiliario elegante y servicios esenciales hacen de este espacio la elección perfecta.', '22-07-2010', 214),
(4, '6845201YJ5210S0087DD', 38.3589899089205, -0.4674039924655232, 2, 140, 3, 2, '4ª planta', 'Elegante y moderno dúplex en Alicante. Con un diseño contemporáneo y equipamiento de alta gama, este hogar ofrece una experiencia de vida excepcional. Disfruta de vistas impresionantes al mar que complementan a la perfección la calidad interior del espacio.', '27-12-2023', 139),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `type_user` varchar(25) COLLATE utf8mb4_es_trad_0900_ai_ci DEFAULT NULL,
  `avatar` varchar(100) COLLATE utf8mb4_es_trad_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id_user`),
...
(1, 'framondo', '$2y$12$2xBQyCFHA3JrxtRtasHk7.GyyXF7DYcdUkcCh77Rs6A4nbCazqPZK', 'framondo@hotmail.com', 'client', 'https://i.pravatar.cc/500?u=cf0e67bc32efb5c316303f1631d06de5'),
(3, 'miguel', '$2y$12$HjfLgcfAZLpTcwvC4K5MaOZdPXvq9bnlhaBLIqe1O9EW7wLrdCmna', 'miguel@hotmail.com', 'client', 'https://i.pravatar.cc/500?u=1040d16f0c1470b7eb07b20644c3e2d8'),
(6, 'cristian', '$2y$12$hW0q5Us.77CyUc6.W18tY.BUlJ.lXku9b6YVnwYO6/8E3PWgOdQUq', 'cristian@hotmail.com', 'client', 'https://i.pravatar.cc/500?u=1818fd2cfaa4d1676f34727bb115138d'),
(7, 'llorenç', '$2y$12$KYrcIf0i.5N5TkCc7s5pNuzQ0.Bd4g/GWP9fdNyVgH5kUfx3ZqOPm', 'llorenc@hotmail.com', 'client', 'https://i.pravatar.cc/500?u=e8dcdff162487261d82958b07fc8f858'),
(8, 'guido', '$2y$12$2/mARIQLWghxwtwUfvJLxeEhRR15mrSI91lhLi9RrSueXSmrP8jWy', 'guido@hotmail.com', 'client', 'https://i.pravatar.cc/500?u=a3286f8ce3783c7d8f5853d317582817');
